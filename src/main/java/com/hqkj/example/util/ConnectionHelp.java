...
public class ConnectionHelp {
	...
	//========== 调用接口路径 start ==========
	//------ （1）接收维修企业数据 ------
//	//public static final String entURL = "http://183.238.238.28:8084/clb/vtsp/synEnt";
//	public static final String entURL = "http://127.0.0.1:8080/syssite/testTask";
//	//------ （2）接收用户数据 ------
//	public static final String entUserURL = "http://127.0.0.1:8080/syssite/testTask";
//	//------ （4）接收车辆数据 ------
//	public static final String vehicleURL = "http://127.0.0.1:8080/syssite/testTask";
