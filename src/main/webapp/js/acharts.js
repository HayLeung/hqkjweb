...
achart_util_110_src_util_debug = function (exports) {
  ...
  var Util = {
      ...
      /**
       * 鍒ゆ柇鏄惁鏁板瓧鎴栬€呮暟瀛楀瓧绗︿覆锛岀敱浜�$.isNumberic鏂规硶浼氭妸 '123'璁や负鏁板瓧
       * @return {Boolean} 鏄惁鏁板瓧
       */
      ...
      extend: function (subclass, superclass, overrides, staticOverrides) {
        ...
        //new superclass(),//瀹炰緥鍖栫埗绫讳綔涓哄瓙绫荤殑prototype
       ...
       * @param  {Number} [tolerance=10] 閫艰繎鑼冨洿
       * @return {Number} 閫艰繎鐨勫€�
       */
      ...
      /**
       * 灏嗘暟瀛椾繚鐣欏搴旀暟瀛楃殑灏忔暟浣�
       * @param  {Number} value 鍊�
       * @param  {Number} base  鍩哄噯鍊�
       * @return {Number}  fixed鍚庣殑鏁板瓧
       */
...
achart_raphael_102_src_eve_debug = function () {
  ...
  // 鈹� Eve 0.4.2 - JavaScript Events Library                      鈹� \\
  // 鈹溾攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹� \\
  // 鈹� Author Dmitry Baranovskiy (http://dmitry.baranovskiy.com/) 鈹� \\
  ...
  (function (glob) {
    ...
    /*\
       * eve.on
       [ method ]
       **
       * Binds given event handler with a given name. You can use wildcards 鈥渀*`鈥� for the names:
       | eve.on("*.under.*", f);
    ...
    *
       ...
       * Note: I assume most of the time you don鈥檛 need to worry about z-index, but it鈥檚 nice to have this feature 鈥渏ust in case鈥�.
      \*/
    ...
    * concated to the list of final arguments.
    ...
    - varargs (鈥�) and any other arguments
     ...
     * or
     = (boolean) `true`, if current event鈥檚 name contains `subname`
    \*/
...
achart_series_107_src_stacked_debug = function (exports) {
  /**
   * @fileOverview 澶勭悊灞傚彔鐨勬暟鎹簭鍒楃殑鎵╁睍
   * @ignore
   */
  var Util = achart_util_110_index_debug;
  /**
   ...
   * @protected
   * 姝ょ被鏄竴涓墿灞曪紝涓嶅簲璇ョ洿鎺ュ疄渚嬪寲,涓昏鐢ㄤ簬鍖哄煙鍥撅紝鏌辩姸鍥惧眰鍙犵殑鍦烘櫙
   *
   *  - <a href="http://spmjs.io/docs/achart-series/latest/api/stacked.html" target="_blank">鏂囨。</a>
  ...
  Stacked.ATTRS = {
     ...
     * 鏁版嵁搴忓垪灞傚彔鐨勭被鍨�
     *   - none : 涓嶈繘琛屽眰鍙 
     *   - normal : 涓€鑸殑灞傚彔鏂瑰紡锛屽悗闈㈢殑鏁版嵁搴忓垪鐨剏鍊煎湪鍓嶄竴涓暟鎹簭鍒楀熀纭€涓婃樉绀�
     *   - percent : 鎸夌収鐧惧垎姣旇繘琛屽眰鍙犲睍绀�
     * @type {String}
     */
    stackType: 'none'
  };
...
achart_theme_101_index_debug = function (exports) {
  /**
   * @fileOverview 鍥捐〃鐨勭毊鑲�
   * @ignore
   */
  var Util = achart_util_110_index_debug;
  /**
   * Chart.Theme
   * @param {Object} cfg  鏍峰紡鐨勯厤缃」
   * @param {Object} base 鎵╁睍鐨勬牱寮�
   */
  ...
  // 鎵€鏈夌殑鍩虹鏍峰紡.鐢变簬娣卞害缁ф壙,鎵€浠ユ暟缁勭被鐨勮嚜宸辫鐩�
...
achart_flags_101_src_flag_debug = function (exports) {
  /**
   * @fileOverview 鍥惧舰鏍囪锛屽寘鍚枃鏈拰杩炴帴绾�
   * @ignoreig
   */
...
achart_series_other_104_src_bubble_debug = function (exports) {
  ...
  Bubble.ATTRS = {
    ...
    legendType: 'circle',
    /**
     * 濡傛灉浼犲叆鐨勬暟鎹槸瀵硅薄閭ｄ箞杩欎釜瀛楁鏍囩ず鍗婂緞浠ｈ〃鐨勫瓧娈�
     * @type {String}
     */
    radiusField: 'r',
    animate: true,
  ...
  Util.augment(Bubble, {
     ...
     * @protected
     * 鑾峰彇鍙互琚縺娲荤殑鍏冪礌
     * @return {Chart.Actived[]} 鍙互琚縺娲荤殑鍏冪礌闆嗗悎
     */
    getActiveItems: function () {
      return this.getItems();
    },
     ...
     * @protected
     * 鏄惁婵€娲�
     * @param {Chart.Actived} item 鍙互琚縺娲荤殑鍏冪礌
     * @return {Chart.Actived[]} 鍙互琚縺娲荤殑鍏冪礌闆嗗悎
     */
    isItemActived: function (item) {
      return item.get('actived');
